(self["webpackChunkol"] = self["webpackChunkol"] || []).push([["vendors-node_modules_geotiff_dist-module_worker_decoder_js"],{
...
function create() {
  ...
  return new web_worker__WEBPACK_IMPORTED_MODULE_0__(typeof Blob === 'undefined' ? 'data:application/javascript;base64,' + Buffer.from(source, 'binary').toString('base64') : URL.createObjectURL(new Blob([source], {
...
//# sourceMappingURL=vendors-node_modules_geotiff_dist-module_worker_decoder_js.ol.js.map
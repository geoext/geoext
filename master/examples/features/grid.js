...
Ext.application({
  ...
  launch: function () {
    ...
    const featRenderer = GeoExt.component.FeatureRenderer;
    const geojson1 = {
      ...
      features: [
        {
          ...
          geometry: {
            type: 'Point',
            coordinates: [10.107421874999998, 53.527247970102465],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [8.76708984375, 50.064191736659104],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [13.447265624999998, 52.53627304145948],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [11.6455078125, 48.1367666796927],
          },
        },
      ],
    };
      ...
      features: [
        {
          ...
          geometry: {
            type: 'Point',
            coordinates: [7.481689453125, 51.49506473014368],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [6.976318359375, 50.93073802371819],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [7.7838134765625, 49.44670029695474],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [7.102661132812499, 50.74688365485319],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [9.1461181640625, 48.77429274267509],
          },
        },
      ],
    };
    ...
    const featArray1 = geojsonFormat.readFeatures(geojson1, {
      dataProjection: 'EPSG:4326',
      featureProjection: 'EPSG:3857',
    });
    const featColl = new ol.Collection(featArray1);

    // loading data via into ol source and create a vector layer to bind a
    // vector layer to a feature store
    const featArray2 = geojsonFormat.readFeatures(geojson2, {
      dataProjection: 'EPSG:4326',
      featureProjection: 'EPSG:3857',
    });
    const featColl2 = new ol.Collection(featArray2);

const redStroke = new ol.style.Stroke({color: 'red', width: 2});
const redFill = new ol.style.Fill({color: [255, 0, 0, 0.25]});
...
Ext.require(['GeoExt.component.FeatureRenderer']);
...
function render() {
  ...
  try {
    ...
    document.getElementById('symbolizers').value =
      'Bad symbolizers: ' + err + '\n\n' + value;
    symbolizers = null;
  }

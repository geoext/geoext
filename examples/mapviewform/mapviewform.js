...
Ext.application({
  ...
  launch: function () {
    ...
    const labLayer = new ol.layer.Tile({
      source: new ol.source.StadiaMaps({
    ...
    const viewRecord = Ext.create('GeoExt.data.model.OlObject', view);

    // wrap ol.layer.Layer in GeoExt Object model
    const layerRecord = Ext.create('GeoExt.data.model.OlObject', layer);
    const labLayerRecord = Ext.create('GeoExt.data.model.OlObject', labLayer);

    const viewForm = Ext.create('Ext.form.Panel', {
      title: 'View',
      bodyPadding: 5,
      defaults: {
        xtype: 'numberfield',
    ...
    const layerForm = Ext.create('Ext.form.Panel', {
    ...
    const labLayerForm = Ext.create('Ext.form.Panel', {
      title: 'Labels Layer',
      bodyPadding: 5,
      defaults: {
        xtype: 'numberfield',

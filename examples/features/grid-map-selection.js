...
Ext.application({
  ...
  launch: function () {
    const geojson = {
      ...
      features: [
        ...
        },
        {
          ...
          geometry: {
            type: 'Point',
            coordinates: [2.35107421875, 48.83579746243093],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [4.888916015625, 52.36218321674427],
          },
        },
        {
          type: 'Feature',
          ...
          geometry: {
            type: 'Point',
            coordinates: [-0.1318359375, 51.467696956223364],
          },
        },
      ],
    };
    ...
    const featColl = new ol.Collection(features);

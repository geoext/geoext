...
describe('GeoExt.util.OGCFilter', function () {
  ...
  describe('static methods', function () {
    ...
    const expectedGetFeature10Filter =
    ...
    const expectedGetFeature11Filter =
    ...
    const expectedGetFeature20Filter =
    ...
    describe('#getOgcWmsFilterFromExtJsFilter', function () {
      it('is defined', function () {
        expect(GeoExt.util.OGCFilter.getOgcWmsFilterFromExtJsFilter).to.be.a(
          'function',
        );
      });
      ...
      describe('WFS 1.0.0', function () {
        const wfsFilter =
          GeoExt.util.OGCFilter.getOgcWfsFilterFromExtJsFilter(filters);
      ...
      describe('WFS 2.0.0', function () {
        const wfs2Filter = GeoExt.util.OGCFilter.getOgcWfsFilterFromExtJsFilter(
          filters,
          'And',
          '2.0.0',
        );
    ...
    describe('#getOgcFilterFromExtJsFilter', function () {
      it('is defined', function () {
        expect(GeoExt.util.OGCFilter.getOgcWfsFilterFromExtJsFilter).to.be.a(
          'function',
        );
      });
      ...
      it('throws with invalid filter array', function () {
        let f;
        try {
          f = GeoExt.util.OGCFilter.getOgcFilterFromExtJsFilter(null, 'wms');
        } catch (e) {
      ...
      it('returns null if called with empty filters array', function () {
        const got = GeoExt.util.OGCFilter.getOgcFilterFromExtJsFilter(
          [],
          'wms',
        );
    ...
    describe('#getOgcFilterBodyFromExtJsFilterObject', function () {
      it('is defined', function () {
        ...
        expect(ogcUtil.getOgcFilterBodyFromExtJsFilterObject).to.be.a(
          'function',
        );
      });
      ...
      it('throws with invalid filter', function () {
        ...
        const ogcUtil = GeoExt.util.OGCFilter;
        try {
          filter = ogcUtil.getOgcFilterBodyFromExtJsFilterObject(null, 'wms');
        } catch (e) {
    ...
    describe('#getOgcFilter', function () {
      it('is defined', function () {
        expect(GeoExt.util.OGCFilter.getOgcFilter).to.be.a('function');
      });

      it('throws with invalid properties', function () {
        let filter;
        try {
          filter = GeoExt.util.OGCFilter.getOgcFilter(null, 'test', undefined);
        } catch (e) {
          expect(filter).to.be(undefined);
        }
      });
      ...
      it('supports spatial filters for WFS 1.x', function () {
        ...
        const propertyName = 'nice-geometry-attribute';
        const topologicalOperators = {
        ...
        Ext.iterate(topologicalOperators, function (key, val) {
          ...
          const expected = Ext.String.format(
      ...
      it('supports WFS 2.0.0 - FES 2.0 filters', function () {
        ...
        const gmlElement = Ext.String.format(
    ...
    describe('#buildWfsGetFeatureWithFilter', function () {
      it('is defined', function () {
        expect(GeoExt.util.OGCFilter.buildWfsGetFeatureWithFilter).to.be.a(
          'function',
        );
      });

      const xml10 = GeoExt.util.OGCFilter.buildWfsGetFeatureWithFilter(
        filters,
        'And',
        '1.0.0',
      ...
      const xml11 = GeoExt.util.OGCFilter.buildWfsGetFeatureWithFilter(
        filters,
        'And',
        '1.1.0',
        'dwd:Warngebiete_Kreise',
      ...
      const xml20 = GeoExt.util.OGCFilter.buildWfsGetFeatureWithFilter(
        filters,
        'And',
        '2.0.0',
        'dwd:Warngebiete_Kreise',
    ...
    describe('#createSpatialFilter', function () {
      it('is defined', function () {
        expect(GeoExt.util.OGCFilter.createSpatialFilter).to.be.a('function');
      });

      it('returns null for invalid operator type', function () {
        const wrongOperator = 'NOT_VALID';
        const result = GeoExt.util.OGCFilter.createSpatialFilter(wrongOperator);
      ...
      it('returns a valid spatial filter', function () {
        ...
        const result = GeoExt.util.OGCFilter.createSpatialFilter(
          operator,
          propertyName,
          geometry,
          epsg,

...
describe('GeoExt.data.model.OlObject', function () {
  ...
  describe('init record from simple javascript object', function () {
    let records = [];
    let objs = [];
    const types = ['plain obj', 'ol.Object'];

    beforeEach(function () {
      const record1 = Ext.create('Test.data.model.Object', props);
      // js object
      records.push(record1);
      objs.push(record1.olObject);

      // ol.Object
      const olObj = new ol.Object(props);
      objs.push(olObj);
    ...
    Ext.Array.each(types, function (t, i) {
      ...
      it(
        t + ": fields don't need to be defined for syncing properties",
        function () {
      ...
      it(
        t + ': changes on the ol.Object are synced to Ext.data.Model',
        function () {
      ...
      it(
        t + ': changes on the Ext.data.Model are synced to ol.Object',
        function () {
      ...
      it(
        t +
          ': setting multiple properties of ol.Object syncs with' +
